...
def main():
    ...
    parser.add_argument('--max_training_time', type=int, default=6*60*60, help='max_training_time')  # 6 hours
    ...
    parser.add_argument('--model', type=str, default='PatchMixer',
                        help='model name, options: [PatchMixer]')
    parser.add_argument('--recover', type=bool, default=True, help='Recover training')
